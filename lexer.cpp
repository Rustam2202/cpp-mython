...
namespace parse {
	...
	std::unordered_map<std::string, parse::Token> KeyWords;
	std::unordered_map<std::string, parse::Token> DualSymbols;
...
#undef UNVALUED_OUTPUT
	...
	void Lexer::ParseChar() {
		...
		if (util::DualSymbols.count(sym_pair)) {
